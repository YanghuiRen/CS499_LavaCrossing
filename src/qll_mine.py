...
if __name__ == "__main__":
    ...
    # draw average reward:
    plt.subplot(1, 2, 1)
    plt.scatter(episodes_axis, mean_rewards_per_episode, label="Episode Rewards (Mean)")
    ...
    plt.subplot(1, 2, 2)
    plt.scatter(episodes_axis, mean_steps_per_episode, label="Episode Steps (Mean)", color='orange')
