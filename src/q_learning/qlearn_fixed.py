...
if __name__ == "__main__":
    ...
    for trial_idx in range(MAX_TRIALS):
        ...
        # rewards_log, steps_log = qlearn(env, trial_seed)
    ...
    plt.savefig(f'images/trials/qlearn/qlearn_{MAX_TRIALS}_{N_EPISODES}_a{ALPHA}_e{EPSILON}.png', dpi=300, bbox_inches='tight')
    plt.show()